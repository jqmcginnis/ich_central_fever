...
parser.add_argument('--template_path', default='../atlas_overlap/registration/MNI152_T1_1mm.nii.gz', help='Path to the template file')
parser.add_argument('--lesion_folder', required=True, help='Path to the lesion segmentations folder')
parser.add_argument('--pattern', default='space-MNI152T1w1mm.nii.gz', help='Pattern to match the lesion files')
...
cbar.set_label('Number of patients', rotation=270, labelpad=20, fontsize=12)
